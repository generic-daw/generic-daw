...
pub const MIN_SPLIT_WIDTH: f32 = 200.0;
pub const MIN_SPLIT_HEIGHT: f32 = 300.0;
pub const DEFAULT_SPLIT_WIDTH: f32 = 300.0;
pub const DEFAULT_SPLIT_HEIGHT: f32 = 400.0;
